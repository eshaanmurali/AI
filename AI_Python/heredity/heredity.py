    ...
    for person in people:
        ...
        if people[person]["mother"] is None:
            ...
            for parent in [mother, father]:
                num_genes_from_parent = sum([1 for gene in [mother, father] if gene in one_gene.union(two_genes)])
                prob_inherit = 0.5 if num_genes_from_parent == 1 else 1 - PROBS["mutation"]
                prob_gene += prob_inherit * (1 - prob_inherit) if gene_count == 1 else prob_inherit ** 2
